...
DROP TABLE IF EXISTS @etl_database.@etl_schema.lk_meas_operator_concept CASCADE;

CREATE TABLE @etl_database.@etl_schema.lk_meas_operator_concept AS
SELECT
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.tmp_meas_unit CASCADE;

CREATE TABLE @etl_database.@etl_schema.tmp_meas_unit AS
SELECT
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.lk_meas_unit_concept CASCADE;

CREATE TABLE @etl_database.@etl_schema.lk_meas_unit_concept AS
SELECT
...
FROM
    @etl_database.@etl_schema.tmp_meas_unit vc
LEFT JOIN
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.tmp_meas_unit;
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.lk_diagnoses_icd_clean CASCADE;

CREATE TABLE @etl_database.@etl_schema.lk_diagnoses_icd_clean AS
SELECT
...
FROM
    @etl_database.@etl_schema.src_diagnoses_icd src
INNER JOIN
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.lk_diagnoses_icd_mapped CASCADE;

CREATE TABLE @etl_database.@etl_schema.lk_diagnoses_icd_mapped AS
SELECT
    src.subject_id                      AS subject_id,
    src.hadm_id                         AS hadm_id,
    ...
    src.trace_id                        AS trace_id
FROM
    @etl_database.@etl_schema.lk_diagnoses_icd_clean src
LEFT JOIN
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.tmp_seq_num_to_concept CASCADE;
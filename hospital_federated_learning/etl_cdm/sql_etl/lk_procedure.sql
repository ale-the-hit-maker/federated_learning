...
DROP TABLE IF EXISTS @etl_database.@etl_schema.lk_datetimeevents_concept CASCADE;
DROP TABLE IF EXISTS @etl_database.@etl_schema.lk_proc_event_clean CASCADE;
DROP TABLE IF EXISTS @etl_database.@etl_schema.lk_datetimeevents_clean CASCADE;
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.lk_hcpcsevents_clean CASCADE;

CREATE TABLE @etl_database.@etl_schema.lk_hcpcsevents_clean AS
 SELECT
...
FROM
    @etl_database.@etl_schema.src_hcpcsevents src
INNER JOIN
    @etl_database.@etl_schema.src_admissions adm
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.lk_procedures_icd_clean CASCADE;

CREATE TABLE @etl_database.@etl_schema.lk_procedures_icd_clean AS
SELECT
    src.subject_id                              AS subject_id,
    src.hadm_id                                 AS hadm_id,
    adm.dischtime                               AS start_datetime,
    ...
    src.trace_id                        AS trace_id
FROM
    @etl_database.@etl_schema.src_procedures_icd src
INNER JOIN
    @etl_database.@etl_schema.src_admissions adm
        ON src.hadm_id = adm.hadm_id
;
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.lk_proc_d_items_clean CASCADE;

CREATE TABLE @etl_database.@etl_schema.lk_proc_d_items_clean AS
SELECT
    src.subject_id                      AS subject_id,
    src.hadm_id                         AS hadm_id,
    ...
    src.trace_id                        AS trace_id
FROM
    @etl_database.@etl_schema.src_procedureevents src
WHERE
...
-- anchor_year
-- -------------------------------------------------------------------
INSERT INTO @etl_database.@etl_schema.lk_proc_d_items_clean
SELECT
    src.subject_id                      AS subject_id,
    src.hadm_id                         AS hadm_id,
    ...
    src.trace_id                        AS trace_id
FROM
    @etl_database.@etl_schema.src_datetimeevents src -- de
INNER JOIN
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.lk_hcpcs_concept CASCADE;

CREATE TABLE @etl_database.@etl_schema.lk_hcpcs_concept AS
SELECT
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.lk_icd_proc_concept CASCADE;

CREATE TABLE @etl_database.@etl_schema.lk_icd_proc_concept AS
SELECT
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.lk_itemid_concept CASCADE;

CREATE TABLE @etl_database.@etl_schema.lk_itemid_concept AS
SELECT
    d_items.itemid                      AS itemid,
    d_items.itemid::TEXT                AS source_code,
    ...
    vc2.concept_id                      AS target_concept_id
FROM
    @etl_database.@etl_schema.src_d_items d_items
LEFT JOIN
    @etl_database.@etl_schema.voc_concept vc
        ON vc.concept_code = d_items.itemid::TEXT
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.lk_procedure_mapped CASCADE;

CREATE TABLE @etl_database.@etl_schema.lk_procedure_mapped AS
SELECT
    ...
    src.trace_id                    AS trace_id
FROM
    @etl_database.@etl_schema.lk_hcpcsevents_clean src
LEFT JOIN
    @etl_database.@etl_schema.lk_hcpcs_concept lc
...
ALTER TABLE @etl_database.@etl_schema.lk_procedure_mapped ALTER COLUMN source_code TYPE character(7);


INSERT INTO @etl_database.@etl_schema.lk_procedure_mapped
SELECT
    src.subject_id                          AS subject_id, -- to person
    src.hadm_id                             AS hadm_id, -- to visit
    src.start_datetime                      AS start_datetime,
    ...
    src.trace_id                    AS trace_id
FROM
    @etl_database.@etl_schema.lk_procedures_icd_clean src
LEFT JOIN
    @etl_database.@etl_schema.lk_icd_proc_concept lc
...
SELECT
    ...
    src.trace_id                    AS trace_id
FROM
    @etl_database.@etl_schema.lk_proc_d_items_clean src
LEFT JOIN
    @etl_database.@etl_schema.lk_itemid_concept lc

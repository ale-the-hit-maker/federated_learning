...
DROP TABLE IF EXISTS @etl_database.@etl_schema.tmp_observation_period_clean;
CREATE TABLE @etl_database.@etl_schema.tmp_observation_period_clean AS
SELECT
...
FROM
    @etl_database.@etl_schema.cdm_visit_occurrence src
GROUP BY
    src.person_id, src.unit_id
;

INSERT INTO @etl_database.@etl_schema.tmp_observation_period_clean
SELECT
    src.person_id               AS person_id,
    ...
    src.unit_id                 AS unit_id
FROM
    @etl_database.@etl_schema.cdm_condition_occurrence src
GROUP BY
    src.person_id, src.unit_id
;
...
SELECT
    ...
    src.unit_id                 AS unit_id
FROM
    @etl_database.@etl_schema.cdm_procedure_occurrence src
GROUP BY
    src.person_id, src.unit_id
;
...
SELECT
    ...
    src.unit_id                 AS unit_id
FROM
    @etl_database.@etl_schema.cdm_drug_exposure src
GROUP BY
    src.person_id, src.unit_id
;
...
SELECT
    ...
    src.unit_id                 AS unit_id
FROM
    @etl_database.@etl_schema.cdm_device_exposure src
GROUP BY
    src.person_id, src.unit_id
;
...
SELECT
    ...
    src.unit_id                 AS unit_id
FROM
    @etl_database.@etl_schema.cdm_measurement src
GROUP BY
    src.person_id, src.unit_id
;
...
SELECT
    ...
    src.unit_id                 AS unit_id
FROM
    @etl_database.@etl_schema.cdm_specimen src
GROUP BY
    src.person_id, src.unit_id
;
...
SELECT
    ...
    src.unit_id                 AS unit_id
FROM
    @etl_database.@etl_schema.cdm_observation src
GROUP BY
    src.person_id, src.unit_id
;
...
SELECT
    ...
    src.unit_id                 AS unit_id
FROM
    @etl_database.@etl_schema.cdm_death src
GROUP BY
    src.person_id, src.unit_id
;
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.tmp_observation_period;
CREATE TABLE @etl_database.@etl_schema.tmp_observation_period AS
SELECT
    src.person_id               AS person_id,
    ...
    src.unit_id                 AS unit_id
FROM
    @etl_database.@etl_schema.tmp_observation_period_clean src
GROUP BY
    src.person_id, src.unit_id
;
...
DROP TABLE IF EXISTS @etl_database.@etl_schema.cdm_observation_period;
...
INSERT INTO @etl_database.@etl_schema.cdm_observation_period
SELECT
    EXTRACT(EPOCH FROM NOW())::BIGINT * 1000000 + ROW_NUMBER() OVER ()  AS observation_period_id,
    src.person_id                               AS person_id,
...
FROM
    @etl_database.@etl_schema.tmp_observation_period src
GROUP BY
    src.person_id
;
